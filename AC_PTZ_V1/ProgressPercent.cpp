...
ProgressPercent::ProgressPercent(QWidget* parent)
	: QWidget(parent)
{
	minValue = 0;
	maxValue = 100;
	...
	circleColor = QColor(70, 70, 70, 40);	// 透明
	textColor = QColor(102, 102, 102);

	percentStyle = PercentStyle_Arc_Wave;
